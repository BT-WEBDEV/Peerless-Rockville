    ...
    <div class="past-events-container"> 
        ...
        <div class="container"> 
            ...
            <?php 
                ...
                $past_events_posts_thingstodo = new WP_Query($args);
                                        
                while ( $past_events_posts_thingstodo->have_posts() ) : $past_events_posts_thingstodo->the_post(); ?>
                    <a href="<?php the_permalink()?>" class="link-wrap">
                        <div class="past-event-post"> 
                            <p class="past-full-date-time">  <?php echo get_field('full_date_time'); ?></p>
                            <h4 class="past-event-title"> <?php echo get_field('event_name'); ?> </h4>
                        </div>
                    </a>
                <?php endwhile; wp_reset_postdata(); ?> 
